...
bool CMysqlConnection::ConnectImpl()
{
	...
	if(m_Config.m_Setup)
	{
		...
		FormatCreateRace(aCreateRace, sizeof(aCreateRace),   false);
		FormatCreateTeamrace(aCreateTeamrace, sizeof(aCreateTeamrace), "VARBINARY(16)",   false);
		FormatCreateMaps(aCreateMaps, sizeof(aCreateMaps));
		FormatCreateSaves(aCreateSaves, sizeof(aCreateSaves),   false);
