...
{
	CConsole::ExecuteLineStroked(1, pStr, ClientId, InterpretSemicolons);  
	CConsole::ExecuteLineStroked(0, pStr, ClientId, InterpretSemicolons);  
}
...
{
	if(str_isallnum(pStr) || ((pStr[0] == '-' || pStr[0] == '+') && str_isallnum(pStr + 1)))  
	{
