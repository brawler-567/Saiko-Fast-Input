...
MACRO_CONFIG_COL(UiColor, ui_color, 0xE4A046AF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Interface color")  
...
MACRO_CONFIG_INT(GfxGLTextureLodBIAS, gfx_gl_texture_lod_bias, -500, -2000, 2000, CFGFLAG_SAVE | CFGFLAG_CLIENT, "OpenGL texture LOD bias (default -500 = sharp)")
...
MACRO_CONFIG_COL(ClBackgroundColor, cl_background_color, 128, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Background color")  
MACRO_CONFIG_COL(ClBackgroundEntitiesColor, cl_background_entities_color, 128, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Background (entities) color")  
