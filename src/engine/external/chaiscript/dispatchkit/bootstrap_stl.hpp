...
namespace chaiscript::bootstrap::standard_library {
  ...
  template<typename ContainerType>
  void random_access_container_type(const std::string &  , Module &m) {
  ...
  template<typename ContainerType>
  void resizable_type(const std::string &  , Module &m) {
  ...
  template<typename ContainerType>
  void reservable_type(const std::string &  , Module &m) {
  ...
  template<typename ContainerType>
  void container_type(const std::string &  , Module &m) {
  ...
  template<typename ContainerType>
  void sequence_type(const std::string &  , Module &m) {
  ...
  template<typename ContainerType>
  void unique_associative_container_type(const std::string &  , Module &m) {
