...
TEST(Filesystem, SplitFileExtension)
{
	...
	fs_split_file_extension("name.ext", aName, sizeof(aName));  
	EXPECT_STREQ(aName, "name");

	fs_split_file_extension("name.ext", nullptr, 0, aExt, sizeof(aExt));  
	EXPECT_STREQ(aExt, "ext");
	...
	fs_split_file_extension("no_dot", aName, sizeof(aName));  
	EXPECT_STREQ(aName, "no_dot");

	fs_split_file_extension("no_dot", nullptr, 0, aExt, sizeof(aExt));  
	EXPECT_STREQ(aExt, "");
	...
	fs_split_file_extension(".dot_first", aName, sizeof(aName));  
	EXPECT_STREQ(aName, ".dot_first");

	fs_split_file_extension(".dot_first", nullptr, 0, aExt, sizeof(aExt));  
	EXPECT_STREQ(aExt, "");
}
