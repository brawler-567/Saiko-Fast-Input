...
static CGameMsg7 gs_GameMsgList7[protocol7::NUM_GAMEMSGS] = {
	{  DO_CHAT, PARA_NONE, "Teams were swapped"},
	{  DO_CHAT, PARA_NONE, "Invalid spectator id used"},  
	{  DO_CHAT, PARA_NONE, "Teams were shuffled"},
	{  DO_CHAT, PARA_NONE, "Teams have been balanced"},
	{  DO_SPECIAL, PARA_NONE, ""},  
	{  DO_SPECIAL, PARA_NONE, ""},  
